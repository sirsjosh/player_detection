...
class Tracker():
    ...
    def draw_ellipse(self, frame, bbox, color, track_id = None):
        ...
        # Convert RGBA to BGR and alpha
        # bgr_color = color[:3]
        # alpha = color[3] / 255.0

        # Create a transparent layer for drawing the ellipse
        # overlay = frame.copy()

        # Draw the ellipse on the overlay
        # cv2.ellipse(overlay, center=(x_center, y2),
    ...
    def draw_annotations(self, video_frames, tracks, team_ball_control):
        ...
        for frame_num, frame in enumerate(video_frames):
            ...
            for track_id, referee in referee_dict.items():
                frame = self.draw_ellipse(frame, referee['bbox'], (0,255,255,128), track_id)
